...
export const userHsAPI = {
    ...
    follow(userHId) {
        return axios.get(`https://wikirip.site/index.php?route=api/addwishlist&customer_id=3&product_id=${userHId}`)
    },
    unfollow(userHId) {
        return axios.get(`https://wikirip.site/index.php?route=api/removewishlist&customer_id=3&product_id=${userHId}`)
    },
    getProfile(userHId) {
        console.warn('Obsolete method. Please profileAPI object.')
